...
do
    ...
    RUN_SCRIPT=$SPMV_DIR/script/coma/test/mic-$DISTRIBUTE_METHOD/run_p${p}.sh
...
PARTITION_DIR=${SPMV_DIR}/partition/test/$DISTRIBUTE_METHOD/
SPMV=${SPMV_DIR}/bin/spmv
SPMV_MIC=${SPMV_DIR}/bin/spmv.mic
