...
#OPTION = -DPRINT_HOSTNAME -DPRINT_PERFORMANCE -DPRINT_REAL_PERFORMANCE -DPRINT_NUMABIND -DUSE_DENSE_INTERNAL_INDEX -DSPMV_OVERLAP
OPTION = -DPRINT_HOSTNAME -DPRINT_PERFORMANCE -DMY_CSRMV
