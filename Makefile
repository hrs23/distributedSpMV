...
#OPTION = -DPRINT_HOSTNAME -DPRINT_PERFORMANCE -DPRINT_REAL_PERFORMANCE -DPRINT_NUMABIND
OPTION = -DPRINT_HOSTNAME -DPRINT_PERFORMANCE -DPRINT_NUMABIND -DUSE_DENSE_INTERNAL_INDEX
